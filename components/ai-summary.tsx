...
import { Sparkles, ChevronDown, ChevronUp, Code, Palette } from "lucide-react"
...
const personaColors: Record<"dev" | "design", string> = {
...
export function AISummaryCard({ summary, category }: AISummaryProps) {
  ...
  const [selectedPersona, setSelectedPersona] = useState<"dev" | "design">(() => {
